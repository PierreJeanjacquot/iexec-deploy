...
chmod 755 /home/ubuntu/iexec-deploy/poa/test/bootpoatestnetV3testdocker.sh
sudo -i -u ubuntu /home/ubuntu/iexec-deploy/poa/test/bootpoatestnetV3testdocker.sh --name CI-TESTNET-CHECK --nodes 2 --gitlogin ${GIT_LOGIN} --gittoken ${GIT_TOKEN}
BOOTSTRAP_RESULT=$?
