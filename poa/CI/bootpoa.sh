...
sed -i "s/d \/home\/parity\/data/d \/home\/parity\/data --force-sealing --gasprice 0 --logging sync=info,snapshot=debug,txqueue=trace,tx=trace,tx_filter=trace,rpc=trace/g" docker-compose.yml
