...
chmod 755 /home/ubuntu/iexec-deploy/poa/CI/sidechainandbridgenonreg.sh
sudo -i -u ubuntu /home/ubuntu/iexec-deploy/poa/CI/sidechainandbridgenonreg.sh  --password $PASSWORD --gitlogin ${GIT_LOGIN} --gittoken ${GIT_TOKEN} --test-ip ${TEST_IP}
BOOTSTRAP_RESULT=$?
