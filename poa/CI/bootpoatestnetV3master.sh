...
./parity-deploy.sh --config aura --name HOME-CHAIN --nodes 1 --expose parity --force-sealing 
...
./parity-deploy.sh --config aura --name FOREIGN-CHAIN --nodes 1  --expose parity --force-sealing
